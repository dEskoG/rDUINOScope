...
//
//
const String FirmwareDate = "03 06 17";
const String FirmwareNumber = "v2.3 Boiana EQ";
...
long UPD_T, UPD_coord, DELAY_Slew, UPD_LST;
int RA_move_ending;
...
// RA_M2 - Pin 12 UP - PD8 -  PIOD->PIO_SODR=(1u<<8);
// RA_M1 - Pin 13 UP - PB27 -  PIOB->PIO_SODR=(1u<<27);
...
// RA_M2 - Pin 12 DOWN - PD8 -  PIOD->PIO_CODR=(1u<<8);
// RA_M1 - Pin 13 DOWN - PB27 -  PIOB->PIO_CODR=(1u<<27);
//
